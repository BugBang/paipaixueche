...
public class BranchSchoolAdapter extends BaseAdapter {

	private Context mContext;
	private List<BranchSchool> mList;
	
	public BranchSchoolAdapter(Context context, List<BranchSchool> list) {
		mContext = context;
		mList = list;
	}
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		BranchSchool item = getItem(position);
		ViewHolder holder;
		if (convertView == null) {
