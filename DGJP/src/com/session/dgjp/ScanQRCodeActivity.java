...
public class ScanQRCodeActivity extends BaseActivity implements OnClickListener, Callback {
	...
	/** 扫描解释出来的内容 */
	public static final String RES_CONTENT = "result";
	/** 扫描出来的Bitmap */
	public static final String RES_BITMAP = "bitmap";
	private CaptureActivityHandler handler;
	private ViewfinderView viewfinderView;
	private boolean hasSurface;
	private Vector<BarcodeFormat> decodeFormats;
	private String characterSet = RegularMatchingUtil.GB2312;
	...
	protected void onResume() {
		...
		decodeFormats = null;
		characterSet = RegularMatchingUtil.GB2312;
		// playBeep = true;
	...
	public void handleDecode(Result result, Bitmap barcode) {
		...
		if (resultString.equals("")) {
			...
			bundle.putString(RES_CONTENT, resultString);
			bundle.putParcelable(RES_BITMAP, barcode);
	...
	private void initCamera(SurfaceHolder surfaceHolder) {
		try {
			...
			builder.setTitle("提示");
			builder.setMessage("照相机不能正常打开，请检查手机");
