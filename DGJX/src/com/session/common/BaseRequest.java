...
public class BaseRequest implements Serializable {
	...
	private transient int requestTimes = 2;//默认请求三次
	...
	public <T extends BaseResponseData> BaseResponse<T> sendRequest(Class<T> clazz) throws Exception
	{
		...
		BaseResponse<T> baseResponse = gson.fromJson(result, new TypeToken<BaseResponse<T>>(){}.getType());
	...
	private void init()
	{
		...
		BaseResponse<InitResponseData> initResponse = gson.fromJson(initResult, new TypeToken<BaseResponse<InitResponseData>>(){}.getType());
